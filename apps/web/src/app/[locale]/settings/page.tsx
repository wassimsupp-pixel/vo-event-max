...
import { Settings, User, Shield, Globe, Save, CheckCircle2 } from 'lucide-react'
  ...
  return (
    <AppLayout eventId="global" locale={locale}>
      <div className="flex flex-col gap-6 p-6 max-w-4xl">
        ...
        {success && (
          <div className="flex items-center gap-2 rounded-lg bg-[var(--color-success-light)] p-3 text-sm text-[var(--color-success)] font-semibold">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="flex items-center gap-1.5 rounded-lg bg-[var(--color-accent)] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[var(--color-accent)]/90 transition-all active:scale-[0.98]"
            >
